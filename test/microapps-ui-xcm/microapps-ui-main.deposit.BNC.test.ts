...
describe("Microapps UI BNC transfer tests", () => {
  ...
  test("Withdraw - enough assets", async () => {
    ...
    await withdrawModal.selectChain("Bifrost");
    await withdrawModal.openTokensList();
    await withdrawModal.waitForTokenListElementsVisible(BNC_ASSET_NAME);
    await withdrawModal.selectToken(BNC_ASSET_NAME);
  ...
  test("Deposit - enough assets", async () => {
    ...
    await depositModal.selectChain("Bifrost");
    await depositModal.openTokensList();
    await depositModal.waitForTokenListElementsVisible(BNC_ASSET_NAME);
