...
export const main = async () => {
  ...
  console.info(
    "soldAssetBalanceBefore " + accountData.free.toBigInt().toString()
  );
  ...
  console.info(
    "boughtAssetBalanceBefore " + accountData.free.toBigInt().toString()
  );
  ...
  accountData = balance as AccountData;
  console.info(
    "soldAssetBalanceAfter " + accountData.free.toBigInt().toString()
  );
  ...
  accountData = balance as AccountData;
  console.info(
    "boughtAssetBalanceAfter " + accountData.free.toBigInt().toString()
  );
