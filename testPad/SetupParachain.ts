...
const pathToFiles =
  "/home/goncer/projects/mangata-node/devops/parachain/config/";
...
async function main() {
  ...
  await waitNewBlock();
  const genesis = fs.readFileSync(pathToFiles + "genesis-state").toString();
  const wasm = fs.readFileSync(pathToFiles + "genesis-wasm").toString();
