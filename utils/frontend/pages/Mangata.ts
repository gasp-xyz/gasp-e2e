...
export class Mangata {
    ...
    async clickOnGetTokens() {
        ...
        await (await this.driver.findElement(By.xpath(BTN_GET_TOKENS))).click();
    }
    ...
    async getAssetValue(){
        await waitForElement(this.driver, DIV_ASSETS_ITEM_VALUE);
        const value = await (await this.driver.findElement(By.xpath(DIV_ASSETS_ITEM_VALUE))).getText();
        return value;
    }
}